...
@WebServlet("/PreSal")
public class PreSal extends HttpServlet {
    ...
    private void preSal(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
