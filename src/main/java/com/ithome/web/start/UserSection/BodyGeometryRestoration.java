...
@WebServlet("/BodyGeometryRestoration")
public class BodyGeometryRestoration extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        bodyGeometryRestoration(request,response);
    }
    ...
    private void bodyGeometryRestoration(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/BodyGeo.jsp").forward(request, response);
    }
