...
@WebServlet("/EDREng")
public class EDREng extends HttpServlet {
    ...
    private void eDREng(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
