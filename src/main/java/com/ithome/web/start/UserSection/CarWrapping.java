...
@WebServlet("/CarWrapping")
public class CarWrapping extends HttpServlet {
    ...
    private void carWrapping(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/CarWrapping.jsp").forward(request, response);
    }
