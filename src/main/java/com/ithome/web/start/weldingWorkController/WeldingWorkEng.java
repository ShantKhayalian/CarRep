...
@WebServlet("/WeldingWorkEng")
public class WeldingWorkEng extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        weldingWorkEng(request, response);
    }
    ...
    private void weldingWorkEng(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
