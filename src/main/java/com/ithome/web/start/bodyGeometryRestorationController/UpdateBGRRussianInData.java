...
public class UpdateBGRRussianInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateBGRRussianInData(request, response);
    }
    ...
    private void updateBGRRussianInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private BodyGR CreateObjectOfText() {
        return new BodyGR(CEnglish, fullText);
    }
