...
@WebServlet("/UpdatePolEng")
public class UpdatePolEng extends HttpServlet {
    ...
    private void updateEng(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoNextPage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/PO/POEnglish.jsp").forward(request, response);
    }
    ...
    private Policyies CreateObjectOfText() {
        return new Policyies(fullText, CRussian);
    }
