...
@WebServlet("/CDRus")
public class CDRus extends HttpServlet {
    ...
    private void CDRus(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        request.setCharacterEncoding("UTF-8");
        sessionControlling(request, response);
        getAdminInfo(request, response);
        getCDInRussian();
        setRequestToCDRussian(request);
    ...
    private void setRequestToCDRussian(HttpServletRequest request) {
