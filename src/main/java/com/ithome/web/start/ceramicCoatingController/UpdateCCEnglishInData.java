package com.ithome.web.start.ceramicCoatingController;
...
@WebServlet("/UpdateCCEnglishInData")
public class UpdateCCEnglishInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateCCEnglishInData(request, response);
    }
    ...
    private void updateCCEnglishInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private CeramicCoating CreateObjectOfText() {
        return new CeramicCoating(fullText, CRussian);
    }
