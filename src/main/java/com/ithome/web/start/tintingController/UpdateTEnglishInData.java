...
@WebServlet("/UpdateTEnglishInData")
public class UpdateTEnglishInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateTEnglishInData(request, response);
    }
    ...
    private void updateTEnglishInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private Tining CreateObjectOfText() {
        return new Tining(fullText, CRussian);
    }
