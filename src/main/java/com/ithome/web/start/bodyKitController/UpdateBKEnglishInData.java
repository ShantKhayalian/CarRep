package com.ithome.web.start.bodyKitController;
...
@WebServlet("/UpdateBKEnglishInData")
public class UpdateBKEnglishInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateBKEnglishInData(request, response);
    }
    ...
    private void updateBKEnglishInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoNextPage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/BK/BKEnglish.jsp").forward(request, response);
    }
    ...
    private BodyKit CreateObjectOfText() {
        return new BodyKit(fullText, CRussian);
    }
