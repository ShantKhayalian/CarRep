...
@WebServlet("/TintingRus")
public class TintingRus extends HttpServlet {
    ...
    private void tintingRus(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
