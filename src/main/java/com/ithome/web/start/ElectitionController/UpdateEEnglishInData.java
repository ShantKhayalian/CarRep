...
@WebServlet("/UpdateEEnglishInData")
public class UpdateEEnglishInData extends HttpServlet {
    ...
    private void gotoNextPage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/Electrition/EEnglish.jsp").forward(request, response);
    }
