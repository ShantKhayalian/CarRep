...
@WebServlet("/AddOilFilterInData")
public class AddOilFilterInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        addOilFilterInData(request,response);
    }
    ...
    private void addOilFilterInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private int CreateNewTextInData() {
        return oilFilterChangeDao.addOilFilterChange(CreateObjectOfText());
    }

    private OilFilterChange CreateObjectOfText() {
        return new OilFilterChange(TextArea,TextArea);
    }
