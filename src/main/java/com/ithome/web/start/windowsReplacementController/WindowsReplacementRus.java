...
@WebServlet("/WindowsReplacementRus")
public class WindowsReplacementRus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        windowsReplacementRus(request, response);
    }
    ...
    private void windowsReplacementRus(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
