...
@WebServlet("/SuspensionRepairC")
public class SuspensionRepairC extends HttpServlet {
    ...
    private List<SuspensionRepair> list = new ArrayList<>();
    private SuspensionRepairDao dao = new SuspensionRepairDao();

    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        suspensionRepair(request,response);
    }
    ...
    private void suspensionRepair(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void getComputerDiagnosticText() {
        list = dao.getAllSuspensionRepair();
    }

    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/SuspentionRepair.jsp").forward(request, response);
    }
