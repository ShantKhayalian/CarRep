...
<div class="login-box">
    <div class="logo">
        <a href="javascript:void(0);">Car Repair<b> admin</b></a>
    ...
    <div class="card">
        <div class="body">
            ...
            <form action="<%=request.getContextPath()%>/AdminSignInCheck" method="post">
                <div class="msg">Please login to Admin Section</div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <button class="btn btn-block bg-pink waves-effect" type="submit">SignIn </button>
                    </div>
                </div>
