...
@WebServlet("/BodyPolishingC")
public class BodyPolishingC extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        bodyPolishingC(request,response);
    }
    ...
    private void bodyPolishingC(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/BodyPolish.jsp").forward(request, response);
    }
