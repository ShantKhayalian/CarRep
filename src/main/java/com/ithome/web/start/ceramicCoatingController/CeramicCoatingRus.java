...
@WebServlet("/CeramicCoatingRus")
public class CeramicCoatingRus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ceramicCoatingRus(request, response);
    }
    ...
    private void ceramicCoatingRus(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
