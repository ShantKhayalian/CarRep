...
@WebServlet("/DeleteTipsEng")
public class DeleteTipsEng extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        deleteTipsEng(request,response);
    }
    ...
    private void deleteTipsEng(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
