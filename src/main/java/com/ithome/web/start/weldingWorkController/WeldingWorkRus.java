...
@WebServlet("/WeldingWorkRus")
public class WeldingWorkRus extends HttpServlet {
    ...
    private void weldingWorkRus(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
