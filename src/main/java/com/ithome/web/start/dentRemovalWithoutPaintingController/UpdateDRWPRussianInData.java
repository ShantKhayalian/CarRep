...
@WebServlet("/UpdateDRWPRussianInData")
public class UpdateDRWPRussianInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateDRWPRussianInData(request, response);
    }
    ...
    private void updateDRWPRussianInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoNextPage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/Den/DenRussian.jsp").forward(request, response);
    }
    ...
    private Dental CreateObjectOfText() {
        return new Dental(CEnglish, fullText);
    }
