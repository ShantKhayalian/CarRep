...
@WebServlet("/CarBodyPaintingRus")
public class CarBodyPaintingRus extends HttpServlet {
    ...
    private void carBodyPaintingRus(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
