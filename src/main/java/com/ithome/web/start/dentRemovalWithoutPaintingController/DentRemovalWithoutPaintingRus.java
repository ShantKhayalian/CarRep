...
@WebServlet("/DentRemovalWithoutPaintingRus")
public class DentRemovalWithoutPaintingRus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        dentRemovalWithoutPaintingRus(request, response);
    }
    ...
    private void dentRemovalWithoutPaintingRus(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
