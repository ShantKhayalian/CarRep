                            ...
                            <li
                                ...
                                <ul class="dropdown-menu">
                                    <li id="menu-item-2081"
                                        ...
                                        <a href="Policy?PageLanguage=en_US" class=" dropdown-item"><fmt:message
                                    ...
                                    <li id="menu-item-2082"
                                        ...
                                        <a href="Policy?PageLanguage=ru_RU" class=" dropdown-item"><fmt:message
            ...
            <div class="col-md-12">
                <div class="banner-heading">
                    <h1 class="banner-title">
                        <fmt:message key="Privacy Policy" bundle="${Bundles}"/>
                    </h1>

                    <ol class="breadcrumb" data-wow-duration="2s"><li><a href="App?PageLanguage=${requestScope.PageLanguage}"><fmt:message
                            key="Home" bundle="${Bundles}"/></a></li>   <li>
                        <fmt:message key="Privacy Policy" bundle="${Bundles}"/></li></ol>                           </div><!-- Banner Heading end -->
            </div><!-- Col end-->
        </div><!-- Row end-->
    </div><!-- Container end-->
</div>
