                            ...
                            <li
                                ...
                                <ul class="dropdown-menu">
                                    <li id="menu-item-2081"
                                        ...
                                        <a href="ElectricianC?PageLanguage=en_US" class=" dropdown-item"><fmt:message
                                    ...
                                    <li id="menu-item-2082"
                                        ...
                                        <a href="ElectricianC?PageLanguage=ru_RU" class=" dropdown-item"><fmt:message
            ...
            <div class="col-md-12">
                <div class="banner-heading">
                    ...
                    <ol class="breadcrumb" data-wow-duration="2s">
                        ...
                        <li><fmt:message key="Electrician" bundle="${Bundles}"/></li>
                    </ol>
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="title-section-area">
                                                        <h2 class="section-title">
                                                            <span><fmt:message key="Electrician" bundle="${Bundles}"/></span> </h2>
                                                    </div><!-- Section title -->
                                                        ...
                                                        <c:set value="${requestScope.PageLanguage}" var="lang"/>
                                                            <c:choose>
                                                                <c:when test="${lang == 'en_US'}">
                                                                    <p>${list.electricianEng}</p>
                                                                </c:when>
                                                                <c:when test="${lang == 'ru_RU'}">
                                                                    <p>${list.electricianRus}</p>
                                                                </c:when>
                                                            </c:choose>
