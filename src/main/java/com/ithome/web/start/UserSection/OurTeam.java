...
public class OurTeam extends HttpServlet {
    ...
    private void ourTeam(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        getEmployeeList();
        setRequestedToPage(request);
        gotoPage(request,response);
    }

    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/OurTeam.jsp").forward(request,response);
    }
