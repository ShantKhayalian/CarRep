                        ...
                        <ul id="main-menu" class="navbar-nav">
                            <li id="menu-item-52"
                                ...
                                <a href="App" class="nav-link dropdown-toggle"
                                   data-toggle="dropdown"> <fmt:message key="Home"
                                                                        bundle="${Bundles}"/></a>
                            </li>
                            <li
                            ...
                            <li
                                ...
                                <ul class="dropdown-menu">
                                    <li id="menu-item-2081"
                                        ...
                                        <a href="ComputerDiagnostics?PageLanguage=en_US" class=" dropdown-item"><fmt:message
                                    ...
                                    <li id="menu-item-2082"
                                        ...
                                        <a href="ComputerDiagnostics?PageLanguage=ru_RU" class=" dropdown-item"><fmt:message
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="title-section-area">
                                                        <h2 class="section-title">
                                                            <span><fmt:message key="Computer Diagnostics" bundle="${Bundles}"/></span> </h2>
                                                    </div><!-- Section title -->
                                            ...
                                            <div class="elementor-element elementor-element-7dc8c679 elementor-widget elementor-widget-text-editor"
                                                ...
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-text-editor elementor-clearfix">
                                                        ...
                                                        <c:forEach items="${requestScope.list}" var="text">
                                                        <c:set value="${requestScope.PageLanguage}" var="lang"/>
                                                            <c:choose>
                                                                <c:when test="${lang == 'en_US'}">
                                                                    <p>${text.oilFilterChangeEng}</p>
                                                                </c:when>
                                                                <c:when test="${lang == 'en_US'}">
                                                                    <p>${text.oilFilterChangeRus}</p>
                                                                </c:when>
                                                            </c:choose>
