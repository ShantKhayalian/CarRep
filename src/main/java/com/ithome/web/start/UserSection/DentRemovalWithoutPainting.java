...
@WebServlet("/DentRemovalWithoutPainting")
public class DentRemovalWithoutPainting extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        dentRemovalWithoutPainting(request,response);
    }
    ...
    private void dentRemovalWithoutPainting(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/Dental.jsp").forward(request, response);
    }
