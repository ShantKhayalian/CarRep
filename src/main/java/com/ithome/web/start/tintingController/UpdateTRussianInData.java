...
@WebServlet("/UpdateTRussianInData")
public class UpdateTRussianInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateTRussianInData(request, response);
    }
    ...
    private void updateTRussianInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoNextPage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/TiT/TiTRussian.jsp").forward(request, response);
    }
    ...
    private Tining CreateObjectOfText() {
        return new Tining(CRussian, fullText);
    }
