package com.ithome.web.start.bodyGeometryRestorationController;
...
import com.ithome.web.start.DaoController.BodyGRDao;
import com.ithome.web.start.DaoController.SuspensionRepairDao;
import com.ithome.web.start.Helpers.AdminChecker;
import com.ithome.web.start.Helpers.SessionChecker;


@WebServlet("/UpdateBGREnglishInData")
public class UpdateBGREnglishInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateBGREnglishInData(request, response);
    }
    ...
    private void updateBGREnglishInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private BodyGR CreateObjectOfText() {
        return new BodyGR(fullText, CRussian);
    }
