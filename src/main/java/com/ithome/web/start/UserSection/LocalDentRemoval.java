...
@WebServlet("/LocalDentRemoval")
public class LocalDentRemoval extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        localDentRemoval(request,response);
    }
    ...
    private void localDentRemoval(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
