...
@WebServlet("/UpdatePolRus")
public class UpdatePolRus extends HttpServlet {
    ...
    private void updatePolRus(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    private Policyies CreateObjectOfText() {
        return new Policyies(fullText, CEnglish);
    }
