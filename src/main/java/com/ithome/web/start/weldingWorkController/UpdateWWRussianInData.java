...
@WebServlet("/UpdateWWRussianInData")
public class UpdateWWRussianInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateWWRussianInData(request, response);
    }
    ...
    private void updateWWRussianInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private Welding CreateObjectOfText() {
        return new Welding(CRussian, fullText);
    }
