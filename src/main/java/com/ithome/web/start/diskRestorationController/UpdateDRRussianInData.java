...
@WebServlet("/UpdateDRRussianInData")
public class UpdateDRRussianInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateDRRussianInData(request, response);
    }
    ...
    private void updateDRRussianInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoNextPage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/DIS/DISRussian.jsp").forward(request, response);
    }
    ...
    private DiskRestoration CreateObjectOfText() {
        return new DiskRestoration(CEnglish, fullText);
    }
