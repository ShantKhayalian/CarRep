...
@WebServlet("/UpdateTermsRus")
public class UpdateTermsRus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       updateTermsRus(request,response);
    }
    ...
    private void updateTermsRus(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private TermsCondition CreateObjectOfText() {
        return new TermsCondition(fullText, CEnglish);
    }
