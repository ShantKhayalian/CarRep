...
@WebServlet("/UpdateSIAVIEnglishInData")
public class UpdateSIAVIEnglishInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateSIAVIEnglishInData(request, response);
    }
    ...
    private void updateSIAVIEnglishInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoNextPage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/SO/SOEnglish.jsp").forward(request, response);
    }
    ...
    private Sound CreateObjectOfText() {
        return new Sound(fullText, CRussian);
    }
