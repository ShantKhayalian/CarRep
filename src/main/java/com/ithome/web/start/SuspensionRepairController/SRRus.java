...
@WebServlet("/SRRus")
public class SRRus extends HttpServlet {
    ...
    private void sRRus(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
