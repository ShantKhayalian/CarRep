...
@WebServlet("/AddTipsEng")
public class AddTipsEng extends HttpServlet {
    ...
    private void addTipsEng(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
