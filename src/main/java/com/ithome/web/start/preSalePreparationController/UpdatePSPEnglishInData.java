package com.ithome.web.start.preSalePreparationController;
...
@WebServlet("/UpdatePSPEnglishInData")
public class UpdatePSPEnglishInData extends HttpServlet {
    private SessionChecker checker = new SessionChecker();
    private String username = null;
    private AdminChecker adminChecker = new AdminChecker();
    private int adminId = 0;
    private List<Admin> adminList = new ArrayList<>();
    private List<PreSale> list = new ArrayList<>();
    private PreSaleDao dao = new PreSaleDao();
    private int id = 0;
    private String fullText = null;
    private String CRussian = null;

    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updatePSPEnglishInData(request, response);
    }
    ...
    private void updatePSPEnglishInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoNextPage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/PS/PSEnglish.jsp").forward(request, response);
    }
    ...
    private PreSale CreateObjectOfText() {
        return new PreSale(fullText, CRussian);
    }
