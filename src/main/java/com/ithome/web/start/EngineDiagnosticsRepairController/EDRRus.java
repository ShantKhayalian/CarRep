...
@WebServlet("/EDRRus")
public class EDRRus extends HttpServlet {
    ...
    private void eDRRus(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
