...
@WebServlet("/SounDis")
public class SounDis extends HttpServlet {
    ...
    private void sounDis(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/SoundDis.jsp").forward(request, response);
    }
