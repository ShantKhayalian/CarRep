        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <form action="UpdateDRCRussianInData" method="post">
                        <div class="header">
                            <h2>
                                Diagnostics Repair
                        ...
                        <c:if test="${requestScope.DiagnosticsRepairList != null}">
                            <c:forEach items="${requestScope.DiagnosticsRepairList}" var="Oil">


                        <div class="body">
                            <textarea id="ckeditor" name="TextArea">
                                ${Oil.diagnosticsRepairRus}
                              </textarea>
                        </div>
