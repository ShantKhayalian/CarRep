...
<head>
    ...
    <link data-minify="1" rel='stylesheet' id='elementor-post-45-css'
          href='css/post-45-57fa0217c0aef687ae0a5ea55e0137ae.css' type='text/css' media='all'/>
                        ...
                        <ul id="main-menu" class="navbar-nav">
                            <li id="menu-item-52"
                                ...
                                <ul class="dropdown-menu">
                                    <li id="menu-item-56"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-35 current_page_item menu-item-56 nav-item active">
                                        <a href="index.html" class=" dropdown-item active">Home one</a>
                                    <li id="menu-item-55"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-55 nav-item">
                                        <a href="index_two.html" class=" dropdown-item">Home two</a>
                                    <li id="menu-item-54"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-54 nav-item">
                                        <a href="index_three.html" class=" dropdown-item">Home Three</a>
                                    <li id="menu-item-53"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-53 nav-item">
                                        <a href="index_four.html" class=" dropdown-item">Home four</a>
                                </ul>
                            </li>
                            <li id="menu-item-57"
                            ...
                            <li id="menu-item-2080"
                                ...
                                <ul class="dropdown-menu">
                                    <li id="menu-item-2081"
                                        ...
                                        <a href="shop.html" class=" dropdown-item">Product</a>
                                    <li id="menu-item-2082"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2082 nav-item">
                                        <a href="shop-single.html" class=" dropdown-item">Shop single</a>
                                </ul>
                            </li>
                            <li id="menu-item-1494"
                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1494 nav-item dropdown">
                                <a href="blog.html" class="nav-link dropdown-toggle" data-toggle="dropdown">Blog</a>
                                <ul class="dropdown-menu">
                                    <li id="menu-item-1986"
                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1986 nav-item">
                                        <a href="blog.html" class=" dropdown-item">Blog List</a>
                                    <li id="menu-item-1750"
                                        class="menu-item menu-item-type-post_type menu-item-object-post menu-item-1750 nav-item">
...
<div id="post-45" class="home-full-width-content post-45 page type-page status-publish hentry" role="main">
    <div class="builder-content">
        <div data-elementor-type="post" data-elementor-id="45" class="elementor elementor-45"
             data-elementor-settings="[]">
            <div class="elementor-inner">
                <div class="elementor-section-wrap">
                    <section
                            class="elementor-element elementor-element-a20e8aa elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section"
                            data-id="a20e8aa" data-element_type="section">
                        <div class="elementor-container elementor-column-gap-default">
                            <div class="elementor-row">
                                <div class="elementor-element elementor-element-d7d6815 elementor-column elementor-col-100 elementor-top-column"
                                     data-id="d7d6815" data-element_type="column">
                                    <div class="elementor-column-wrap  elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            <div class="elementor-element elementor-element-5c56ee9 elementor-widget elementor-widget-autrics-title"
                                                 data-id="5c56ee9" data-element_type="widget"
                    ...
                    <section
                            class="elementor-element elementor-element-292ccac elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section"
                            data-id="292ccac" data-element_type="section">
                        <div class="elementor-container elementor-column-gap-default">
                            <div class="elementor-row">
                                <div class="elementor-element elementor-element-f93b72a elementor-column elementor-col-33 elementor-top-column"
                                     data-id="f93b72a" data-element_type="column">
                                    <div class="elementor-column-wrap  elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            <div class="elementor-element elementor-element-8b4014b elementor-widget elementor-widget-autrics-team"
                                                 data-id="8b4014b" data-element_type="widget"
                                                 data-widget_type="autrics-team.default">
                                                <div class="elementor-widget-container">
                                                    ...
                                                    <div class="ts-team-info">
                                                        <img src="http://demo.themewinter.com/wp/autrics/wp-content/uploads/2019/01/team1.png"
                                                             alt=" Jhon Wick" class="img-fluid">

                                                        <div class="team-content">
                                                            <div class="team-details">
                                                                <h3 class="team-name">

                                                                    <c:set var="language" value="${requestScope.Pagelanguage}"/>
                                                                    <c:choose>
                                                                            <c:when test="${language == 'en_US'}">
                                                                    ${Employees.firstName} ${Employees.lastName}</h3>
                                                                <p> ${Employees.perfession} </p>
                                                            ...
                                                            <div class="team-text">
                                                                ...
                                                                <p>Year Of experience<span>${Employees.experianceYears}</span></p>
                                                                <p>Date of birth<span>${Employees.dateOfBirth}</span></p>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    ${Employees.firstNamRue} ${Employees.lastNameRu}</h3>
                                                                <p> ${Employees.perfessionRu} </p>
                                                                <span class="team-rating">
                                                            ...
                                                            <div class="team-text">
                                                                ...
                                                                <p>Год опыта<span>${Employees.experianceYears}</span></p>
                                                                <p>Дата рождения<span>${Employees.dateOfBirth}</span></p>
                                                                </c:otherwise>
                                                                </c:choose>
                                                            </div>
                                                        </div> <!-- Post Body End -->
                    ...
                    <section
                            class="elementor-element elementor-element-ae6e500 elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section"
                            data-id="ae6e500" data-element_type="section">
                        <div class="elementor-container elementor-column-gap-default">
                            <div class="elementor-row">
                                <div class="elementor-element elementor-element-977d055 elementor-column elementor-col-100 elementor-top-column"
                                     data-id="977d055" data-element_type="column">
                                    <div class="elementor-column-wrap  elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            <div class="elementor-element elementor-element-3adce00 elementor-widget elementor-widget-autrics-process"
                                                 data-id="3adce00" data-element_type="widget"
