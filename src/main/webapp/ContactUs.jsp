...
<head>
    ...
    <link data-minify="1" rel='stylesheet' id='elementor-post-72-css'
          href='http://demo.themewinter.com/wp/autrics/wp-content/cache/min/1/wp/autrics/wp-content/uploads/elementor/css/post-72-d6beca201ce97e1cb1c54083603962ee.css'
          type='text/css' media='all'/>
                            ...
                            <li id="menu-item-57"
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li id="menu-item-59"
                                        ...
                                        <a href="our_team.html" class=" dropdown-item"><fmt:message key="Our.Team"
                                                                                                    bundle="${Bundles}"/></a>
                                    <li id="menu-item-58"
                            ...
                            <li id="menu-item-75"
                                ...
                                <ul class="dropdown-menu">
                                    <li id="menu-item-77"
                                        ...
                                        <a href="services-all.html" class=" dropdown-item"><fmt:message
                                                key="Services.All" bundle="${Bundles}"/></a>
                                    <li id="menu-item-1708"
                                        class="menu-item menu-item-type-post_type menu-item-object-ts_service menu-item-1708 nav-item">
                                        <a href="services-single.html" class=" dropdown-item"><fmt:message
                                                key="Services.Single" bundle="${Bundles}"/></a>
                                </ul>
                            </li>
                            <li id="menu-item-2080"
                                ...
                                <ul class="dropdown-menu">
                                    <li id="menu-item-2081"
                                        ...
                                        <a href="<%=request.getAttribute("PageName")%>?Pagelanguage=en_US"
                                           class=" dropdown-item"><fmt:message key="English" bundle="${Bundles}"/></a>
                                    <li id="menu-item-2082"
                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2082 nav-item">
                                        <a href="<%=request.getAttribute("PageName")%>?Pagelanguage=ru_RU"
                                           class=" dropdown-item"><fmt:message key="Russian" bundle="${Bundles}"/></a>
                                </ul>
                            </li>
...
<div class="banner-area bg-overlay  " id="banner-area" style="background-image:url(images/contact_banner.jpg);">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="banner-heading">
                    ...
                    <ol class="breadcrumb" data-wow-duration="2s">
                        <li><a href="http://demo.themewinter.com/wp/autrics">Home</a></li>
                        <li>Contact</li>
                    </ol>
...
<div id="post-72" class="home-full-width-content post-72 page type-page status-publish hentry" role="main">
    <div class="builder-content">
        <div data-elementor-type="post" data-elementor-id="72" class="elementor elementor-72 elementor-bc-flex-widget"
             data-elementor-settings="[]">
            <div class="elementor-inner">
                <div class="elementor-section-wrap">
                    <section
                            class="elementor-element elementor-element-640ae6a elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section"
                            data-id="640ae6a" data-element_type="section">
                        <div class="elementor-container elementor-column-gap-no">
                            <div class="elementor-row">
                                <div class="elementor-element elementor-element-6b97078 elementor-column elementor-col-50 elementor-top-column"
                                     data-id="6b97078" data-element_type="column">
                                    <div class="elementor-column-wrap  elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            <div class="elementor-element elementor-element-567154d elementor-widget elementor-widget-google_maps"
                                                 data-id="567154d" data-element_type="widget"
                                ...
                                <div class="elementor-element elementor-element-5be7eb2 elementor-column elementor-col-50 elementor-top-column"
                                     data-id="5be7eb2" data-element_type="column">
                                    <div class="elementor-column-wrap  elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            <div class="elementor-element elementor-element-252281a elementor-widget elementor-widget-heading"
                                                 data-id="252281a" data-element_type="widget"
                                                 data-widget_type="heading.default">
                                                <div class="elementor-widget-container">
                                                    <h2 class="elementor-heading-title elementor-size-default">Contact
                                                        Details</h2></div>
                                            </div>
                                            <div class="elementor-element elementor-element-4f9f0b5 elementor-widget elementor-widget-text-editor"
                                                 data-id="4f9f0b5" data-element_type="widget"
                                                 data-widget_type="text-editor.default">
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-text-editor elementor-clearfix">
                                                        <div class="contact-info-item"><h3
                                                                class="column-title no-border text-white">Find
                                                            Location</h3>
                                                            <p>1014 Retreat Avenue, Birmingham, AL</p></div>
                                                        <div class="contact-info-item"><h3
                                                                class="column-title no-border text-white">Call Us
                                                            24/7</h3>
                                                            <p>+91 458 654 528 (Toll free)</p></div>
                                                        <div class="contact-info-item"><h3
                                                                class="column-title no-border text-white">Mail Us</h3>
                    ...
                    <section
                            class="elementor-element elementor-element-10bcbb9 elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section"
                            data-id="10bcbb9" data-element_type="section">
                        <div class="elementor-container elementor-column-gap-default">
                            <div class="elementor-row">
                                <div class="elementor-element elementor-element-1c9211f elementor-column elementor-col-50 elementor-top-column"
                                     data-id="1c9211f" data-element_type="column">
                                    <div class="elementor-column-wrap  elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            <div class="elementor-element elementor-element-6f304a2 elementor-widget elementor-widget-autrics-title"
                                                 data-id="6f304a2" data-element_type="widget"
                                            ...
                                            <div class="elementor-element elementor-element-10616d6 elementor-widget elementor-widget-shortcode"
                                                 data-id="10616d6" data-element_type="widget"
                                                 data-widget_type="shortcode.default">
                                                <div class="elementor-widget-container">
                                                    <div class="elementor-shortcode">
                                                        <div role="form" class="wpcf7" id="wpcf7-f1537-p72-o1"
                                                             lang="en-US" dir="ltr">
                                                            <div class="screen-reader-response"></div>
                                                            <form action="SendEmail?PageLanguage=${requestScope.Pagelanguage}"
                                                                  method="post">
                                                                 <div style="display: none;">
                                                                     <input type="hidden" name="_wpcf7" value="1537" />
                                                                     <input type="hidden" name="_wpcf7_version" value="5.1.1" />
                                                                     <input type="hidden" name="_wpcf7_locale" value="en_US" />
                                                                     <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f1537-p72-o1" />
                                                                ...
                                                                <div class="contact-us">
                                                                    <div class="contactMe ts-main-form">
                                                                        <div class="form-row">
                                                                            <div class="col-lg-6">
                                                                            <span class="wpcf7-form-control-wrap text-255">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                            <span class="wpcf7-form-control-wrap tel-348">
                                                                                <input type="tel"
                                                                                       name="senderPhoneNumber" value=""
                                                                                       size="40"
                                                                        ...
                                                                        <div class="form-row">
                                                                            <div class="col-md-6">
                                                                            <span class="wpcf7-form-control-wrap email-540">
                                                                                <input type="email"
                                                                            ...
                                                                            <span class="wpcf7-form-control-wrap menu-465">
                                                                                <select name="menu"
                                                                                    ...
                                                                                    <option value="Air Conditioning Evac">Air Conditioning Evac</option>
                                                                                </select>
                                                                            </span>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-row">
                                                                            <div class="col-md-12">
                                                                            <span class="wpcf7-form-control-wrap textarea-406">
                                                                                <textarea name="senderMessage" cols="40"
                                                                                          rows="10"
                                                                                          class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required field"
                                                                                          aria-invalid="false"
                                ...
                                <div class="elementor-element elementor-element-c172b3e elementor-column elementor-col-50 elementor-top-column"
                                     data-id="c172b3e" data-element_type="column">
                                    <div class="elementor-column-wrap  elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            <section
                                                    class="elementor-element elementor-element-1e63f36 elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-inner-section"
                                                    data-id="1e63f36" data-element_type="section">
                                                <div class="elementor-container elementor-column-gap-default">
                                                    <div class="elementor-row">
                                                        <div class="elementor-element elementor-element-c23a20c elementor-column elementor-col-100 elementor-inner-column"
                                                             data-id="c23a20c" data-element_type="column">
                                                            <div class="elementor-column-wrap  elementor-element-populated">
                                                                <div class="elementor-widget-wrap">
                                                                    <div class="elementor-element elementor-element-408d853 elementor-widget elementor-widget-autrics-title"
                                                                         data-id="408d853" data-element_type="widget"
                                                                         data-widget_type="autrics-title.default">
                                                                        <div class="elementor-widget-container">
                                                                            <div class="title-section-area title-border-none">
                                                                                <h3 class="section-title">
                                                                                    <span>Working</span> Hours </h3>
                                                                            </div><!-- Section title -->


                                                                        </div>
                                                                    </div>
                                                                    <div class="elementor-element elementor-element-04f61f0 weeklay-schedule elementor-widget elementor-widget-autrics-intro-contact"
                                                                         data-id="04f61f0" data-element_type="widget"
                                            ...
                                            <section
                                                    class="elementor-element elementor-element-7359ec9 elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-inner-section"
                                                    data-id="7359ec9" data-element_type="section">
                                                <div class="elementor-container elementor-column-gap-default">
                                                    <div class="elementor-row">
                                                        <div class="elementor-element elementor-element-1376f54 elementor-column elementor-col-100 elementor-inner-column"
                                                             data-id="1376f54" data-element_type="column">
                                                            <div class="elementor-column-wrap  elementor-element-populated">
                                                                <div class="elementor-widget-wrap">
                                                                    <div class="elementor-element elementor-element-d6b2661 elementor-widget elementor-widget-autrics-title"
                                                                         data-id="d6b2661" data-element_type="widget"
                                                                         data-widget_type="autrics-title.default">
                                                                        <div class="elementor-widget-container">
                                                                            <div class="title-section-area title-border-none">
                                                                                <h3 class="section-title">
                                                                                    <span>On </span>Socials </h3>
                                                                            </div><!-- Section title -->


                                                                        </div>
                                                                    </div>
                                                                    <div class="elementor-element elementor-element-13a0826 elementor-shape-circle elementor-widget elementor-widget-social-icons"
                                                                         data-id="13a0826" data-element_type="widget"
                                                                        ...
                                                                        <div class="elementor-widget-container">
                                                                            <div class="elementor-social-icons-wrapper">
                                                                                ...
                                                                                <a class="elementor-icon elementor-social-icon elementor-social-icon-google-plus"
                                                                                   href="" target="_blank">
                                                                                    <span class="elementor-screen-only">Google-plus</span>
                                                                                    <i class="fa fa-google-plus"></i>
                                                                                </a>
                                                                                <a class="elementor-icon elementor-social-icon elementor-social-icon-jsfiddle"
                                                                                   href="" target="_blank">
                    ...
                    <section
                            class="elementor-element elementor-element-ab9c6f6 solid-bg elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section"
                            data-id="ab9c6f6" data-element_type="section">
                        <div class="elementor-container elementor-column-gap-default">
                            <div class="elementor-row">
                                <div class="elementor-element elementor-element-281ba76 elementor-column elementor-col-100 elementor-top-column"
                                     data-id="281ba76" data-element_type="column">
                                    <div class="elementor-column-wrap  elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            <div class="elementor-element elementor-element-f9e472f elementor-widget elementor-widget-image-carousel"
                                                 data-id="f9e472f" data-element_type="widget"
                                                 data-settings="{&quot;slides_to_show&quot;:&quot;5&quot;,&quot;slides_to_scroll&quot;:&quot;5&quot;,&quot;navigation&quot;:&quot;none&quot;,&quot;pause_on_hover&quot;:&quot;yes&quot;,&quot;autoplay&quot;:&quot;yes&quot;,&quot;autoplay_speed&quot;:5000,&quot;infinite&quot;:&quot;yes&quot;,&quot;speed&quot;:500,&quot;direction&quot;:&quot;ltr&quot;}"
                                                    ...
                                                    <div class="elementor-image-carousel-wrapper elementor-slick-slider"
                                                        ...
                                                        <div class="elementor-image-carousel">
                                                            <div class="slick-slide">
                                                                <figure class="slick-slide-inner"><img
                    ...
                    <section
                            class="elementor-element elementor-element-14d6a68 elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section"
                            data-id="14d6a68" data-element_type="section">
                        <div class="elementor-container elementor-column-gap-default">
                            <div class="elementor-row">
                                <div class="elementor-element elementor-element-70f5219 elementor-column elementor-col-100 elementor-top-column"
                                     data-id="70f5219" data-element_type="column">
                                    <div class="elementor-column-wrap  elementor-element-populated">
                                        <div class="elementor-widget-wrap">
                                            <div class="elementor-element elementor-element-21b6cc8 elementor-widget elementor-widget-autrics-process"
                                                 data-id="21b6cc8" data-element_type="widget"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-widget widget-service">
                    <div id="nav_menu-2" class="footer-area-2 widget_nav_menu"><h4 class="widget-title"><span>Our</span>
                        Services</h4>
