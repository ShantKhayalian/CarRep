...
public class LocalDentRemovalEng extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        localDentRemovalEng(request, response);
    }
    ...
    private void localDentRemovalEng(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
