...
@WebServlet("/UpdateCCRussianInData")
public class UpdateCCRussianInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateCCRussianInData(request, response);
    }
    ...
    private void updateCCRussianInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private CeramicCoating CreateObjectOfText() {
        return new CeramicCoating(fullText, CEnglish);
    }
