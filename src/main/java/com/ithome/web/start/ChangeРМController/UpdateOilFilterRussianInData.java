...
public class UpdateOilFilterRussianInData extends HttpServlet {
    ...
    private void updateOilFilterRussianInData(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    private void gotoNextPage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/ChangePMChangeRussian.jsp").forward(request, response);
    }
