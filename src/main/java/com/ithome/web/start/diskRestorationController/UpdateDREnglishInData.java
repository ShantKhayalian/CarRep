...
@WebServlet("/UpdateDREnglishInData")
public class UpdateDREnglishInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateDREnglishInData(request, response);
    }
    ...
    private void updateDREnglishInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private DiskRestoration CreateObjectOfText() {
        return new DiskRestoration(fullText, CRussian);
    }
