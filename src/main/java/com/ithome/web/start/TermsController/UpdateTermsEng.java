...
@WebServlet("/UpdateTermsEng")
public class UpdateTermsEng extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateTermsEng(request,response);
    }
    ...
    private void updateTermsEng(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoNextPage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/CW/CWEnglish.jsp").forward(request, response);
    }
    ...
    private TermsCondition CreateObjectOfText() {
        return new TermsCondition(fullText, CRussian);
    }
