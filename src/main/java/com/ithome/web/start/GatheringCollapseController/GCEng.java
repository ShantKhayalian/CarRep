...
@WebServlet("/GCEng")
public class GCEng extends HttpServlet {
    ...
    private void gCEng(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void getTextEnglish() {
        gatheringCollapses = gatheringCollapseDao.getGatheringCollapseInEnglish();
    }
