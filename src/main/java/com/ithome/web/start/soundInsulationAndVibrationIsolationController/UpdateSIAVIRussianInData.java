...
@WebServlet("/UpdateSIAVIRussianInData")
public class UpdateSIAVIRussianInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateSIAVIRussianInData(request, response);
    }
    ...
    private void updateSIAVIRussianInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private Sound CreateObjectOfText() {
        return new Sound(CRussian,fullText);
    }
