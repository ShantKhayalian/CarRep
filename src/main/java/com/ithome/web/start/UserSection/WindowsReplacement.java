...
@WebServlet("/WindowsReplacement")
public class WindowsReplacement extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        windowsReplacement(request,response);
    }
    ...
    private void windowsReplacement(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/Windows.jsp").forward(request, response);
    }
