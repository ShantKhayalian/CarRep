...
@WebServlet("/UpdateLDREnglishInData")
public class UpdateLDREnglishInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateLDREnglishInData(request, response);
    }
    ...
    private void updateLDREnglishInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
