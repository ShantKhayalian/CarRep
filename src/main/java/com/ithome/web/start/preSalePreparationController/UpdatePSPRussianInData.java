...
@WebServlet("/UpdatePSPRussianInData")
public class UpdatePSPRussianInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updatePSPRussianInData(request, response);
    }
    ...
    private void updatePSPRussianInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoNextPage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/PS/PSRussian.jsp").forward(request, response);
    }
    ...
    private PreSale CreateObjectOfText() {
        return new PreSale(CEnglish, fullText);
    }
