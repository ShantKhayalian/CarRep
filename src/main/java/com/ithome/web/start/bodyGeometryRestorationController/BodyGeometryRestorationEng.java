...
@WebServlet("/BodyGeometryRestorationEng")
public class BodyGeometryRestorationEng extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        bodyGeometryRestorationEng(request, response);
    }
    ...
    private void bodyGeometryRestorationEng(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
