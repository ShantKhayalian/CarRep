...
@WebServlet("/PreSalePreparationRus")
public class PreSalePreparationRus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        preSalePreparationRus(request, response);
    }
    ...
    private void preSalePreparationRus(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
