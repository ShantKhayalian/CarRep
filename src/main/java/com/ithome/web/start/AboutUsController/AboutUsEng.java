...
@WebServlet("/AboutUsEng")
public class AboutUsEng extends HttpServlet {
     ...
     * @throws IOException
     */
    private void aboutUsEng(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.setCharacterEncoding("UTF-8");
        sessionControlling(request, response);
        getAdminInfo(request, response);
        getAboutUsInEnglosh();
        setRequestToAboutUsEnglish(request);
     ...
     * @param request
     */
    private void setRequestToAboutUsEnglish(HttpServletRequest request) {
     ...
     */
    private void getAboutUsInEnglosh() {
