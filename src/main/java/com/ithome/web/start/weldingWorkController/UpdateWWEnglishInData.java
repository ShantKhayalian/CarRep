package com.ithome.web.start.weldingWorkController;
...
@WebServlet("/UpdateWWEnglishInData")
public class UpdateWWEnglishInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateWWEnglishInData(request, response);
    }
    ...
    private void updateWWEnglishInData(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void gotoNextPage(HttpServletRequest request, HttpServletResponse response, String message) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/WE/WEEnglish.jsp").forward(request, response);
    }
    ...
    private Welding CreateObjectOfText() {
        return new Welding(fullText, CRussian);
    }
