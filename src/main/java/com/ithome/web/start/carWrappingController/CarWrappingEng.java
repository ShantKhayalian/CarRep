...
@WebServlet("/CarWrappingEng")
public class CarWrappingEng extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        carWrappingEng(request, response);
    }
    ...
    private void carWrappingEng(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
