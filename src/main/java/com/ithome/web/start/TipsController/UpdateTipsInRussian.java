...
@WebServlet("/UpdateTipsInRussian")
public class UpdateTipsInRussian extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateTipsInRussian(request,response);
    }
    ...
    private void updateTipsInRussian(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    private void goBackToPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/WEB-INF/Tips/TipsRussianWithId.jsp").forward(request, response);
    }
    ...
    private void getTipsEnglishById(int id) {
        vehicleTipsList = tipsDao.getTipsInRussianById(id);
    }
