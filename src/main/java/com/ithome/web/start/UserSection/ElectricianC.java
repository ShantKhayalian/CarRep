...
@WebServlet("/ElectricianC")
public class ElectricianC extends HttpServlet {
    ...
    private List<Electrician> list = new ArrayList<>();
    private ElectricianDao dao = new ElectricianDao();

    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        electricianC(request,response);
    }
    ...
    private void electricianC(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void getComputerDiagnosticText() {
        list = dao.getAllElectrician();
    }

    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/Electrition.jsp").forward(request, response);
    }
