...
@WebServlet("/EngineDiagnosticsRepairC")
public class EngineDiagnosticsRepairC extends HttpServlet {
    ...
    private List<EngineDiagnosticsRepair> list = new ArrayList<>();
    private EngineDiagnosticsRepairDao dao = new EngineDiagnosticsRepairDao();

    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        engineDiagnosticsRepairC(request,response);
    }
    ...
    private void engineDiagnosticsRepairC(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void getComputerDiagnosticText() {
        list = dao.getAllEngineDiagnosticsRepair();
    }

    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/EngineDiagnostics.jsp").forward(request, response);
    }
