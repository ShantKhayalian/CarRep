...
public class BodyPolishingRus extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        bodyPolishingRus(request, response);
    }
    ...
    private void bodyPolishingRus(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
