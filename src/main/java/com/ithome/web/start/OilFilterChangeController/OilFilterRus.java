...
@WebServlet("/OilFilterRus")
public class OilFilterRus extends HttpServlet {
    ...
    private void oilFilterRus(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
