...
@WebServlet("/RepairMaintenanceConditionersC")
public class RepairMaintenanceConditionersC extends HttpServlet {
    ...
    private List<Conditioners> list = new ArrayList<>();
    private ConditionersDao dao = new ConditionersDao();

    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        repairMaintenanceConditionersC(request,response);
    }
    ...
    private void repairMaintenanceConditionersC(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    private void getComputerDiagnosticText() {
        list = dao.getAllConditioners();
    }

    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/Conditioner.jsp").forward(request, response);
    }
