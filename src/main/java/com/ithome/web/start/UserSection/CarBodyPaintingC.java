...
@WebServlet("/CarBodyPaintingC")
public class CarBodyPaintingC extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        carBodyPainting(request,response);
    }
    ...
    private void carBodyPainting(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    private void gotoPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/CarBodyPainting.jsp").forward(request, response);
    }
