...
public class UpdateAboutUsRussianInData extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        updateAboutUsRussianInData(request,response);
    }
    ...
    private void updateAboutUsRussianInData(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ...
    private void UpdateTextInDataRus(int createNewTextInData, HttpServletRequest request, HttpServletResponse response, int i) throws ServletException, IOException {
    ...
    private int CreateNewTextInData(int id){
        return aboutUsDao.UpdateAboutusRus(fullText,id);
    }
